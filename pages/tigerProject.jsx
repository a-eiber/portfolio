    ...
    <div className="w-full">
      ...
      <div className="max-w-[42em] mx-auto p-2 flex flex-col pt-8 px-8">
        <div className="col-span-4 dark:text-white">
          <h2>Overview</h2>
          <p className="my-3">
            A personal project, this web application was used to administer a
          ...
          <p className="mb-3">
            I&apos;m planning on adding additional functionality like accepting
            registration payments using the Stripe API, as well as ironing out
            the process for adding games to the schedule and updating results
            and standings.
          </p>
