...
import githubImg from "../public/assets/skills/github3.png";
    ...
    <section id="skills" className="w-full container p-2 pt-8">
      <div className="max-w-[1240px] mx-auto flex flex-col justify-center h-full">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-6 sm:mx-auto">
          <div className="p-4 shadow-xl rounded-xl hover:scale-105 ease-in duration-300 dark:shadow-none">
          ...
          <div className="p-4 shadow-xl rounded-xl hover:scale-105 ease-in duration-300 dark:shadow-none">
            <div className="grid grid-cols-2 gap-4 justify-center items-center">
              <div className="m-auto">
                <Image src={githubImg} alt="/" width="64px" height="64px" className="bg-[#152028] rounded" />
              </div>
              <div className="flex flex-col items-center justify-center">
